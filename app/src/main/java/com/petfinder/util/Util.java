                ...
                public Object execute(String innerUrl) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            //USE CLOSES THE STREAM AFTER ITS USE, IT IS THE LAMBDA PARAMETER WHICH IS THE BUFFERED READER WHICH IS IMPLICITLY PASS SO ITS NOT DECLARED IN THE BODY
                            responseData = new BufferedReader(new InputStreamReader(urlConnection.getInputStream()));

                            StringBuilder responseBuilder = new StringBuilder();

                            String lineHolder;
                            while ((lineHolder = responseData.readLine()) != null) {
